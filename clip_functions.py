        ...
        #until M>5:
				...
				readsoft=1
                                if piece[1]-5<=0:
                                        ...
                                        newCigar.insert(0,(0,piece[1]-(5-M)))
                                        R+=(5-M)
                                        M+=(5-M)
                                continue
                        if piece[0]==1:
